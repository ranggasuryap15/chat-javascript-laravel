<div id="chat_box" class="chat_box pull-right" style="display: none;">
    <div class="row">
        <div class="col-xs-12 col-md-12">
                <div class="panel panel-default" style="background-image: linear-gradient(rgba(255,255,255,0.5), rgba(255,255,255,0.5)), url('../images/bg_chat.png');">
                    ...
                    <div class="panel-footer" style="margin: 0%">
                        <div class="input-group form-controls">
                            ...
                            <input type="text" name="" id="" class="form-control input-sm chat_input">
